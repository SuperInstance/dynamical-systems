//! Behavioral dynamics: attractors as stable behavioral patterns.
...
/// A behavioral attractor represents a stable pattern of behavior.
...
impl BehavioralDynamics {
    ...
    /// Predict which attractor a system starting at `x0` will converge to.
